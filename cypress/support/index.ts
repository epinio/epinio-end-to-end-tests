...
declare global {
  ...
  namespace Cypress {
    interface Chainable {
      ...
      checkApp(appName: string, namespace?: string, route?: string, checkVar?: boolean, checkConfiguration?: boolean, dontCheckRouteAccess?: boolean, instanceNum?: number, serviceName?: string): Chainable<Element>;
