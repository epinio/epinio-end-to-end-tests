...
declare global {
  ...
  namespace Cypress {
    interface Chainable {
      ...
      checkApp(appName: string, namespace?: string, route?: string, checkVar?: boolean, checkConfiguration?: boolean, dontCheckRouteAccess?: boolean, instanceNum?: string ): Chainable<Element>;
